...
regexes <- list(c("(God|Bless|Spiritual|Lord|Amen|Muslim|Islam)","Religion"),
                c("(Migrant|Border|Immigrant|Refugee|Visa|Citizen|Syria)","Immigration"),
                c("(GDP|Economy|Export|Import|Employ)","Economy"),
                c("(Obamacare|Health|Insurance|illness|doctor)","Healthcare"),
                c("(Army|Military|Troop|Marines|Navy|War)","Military"),
                c("(Gun|2ndAmendment|Shoot|Arms|Rifle|Weapon|NRA)","Gun Control"),
                c("(China|Chinese|Shanghai|Beijing|Asia)","China"),
                c("(Trade|PTT|Export|Import|Tariff)","Trade"),
                c("(Blacklivesmatter|Race|Color|White|Racial|Black)","Race"),
